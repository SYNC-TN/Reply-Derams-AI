...
const SignUp: React.FC<SignUpProps> = ({ onToggle }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Sign in - Add a small delay to ensure database consistency
      await new Promise((resolve) => setTimeout(resolve, 500));

      const result = await signIn("credentials", {
        email: email.toLowerCase(), // Ensure email case matches
        password,
        callbackUrl: "/dreams",
  ...
  return (
    <>
      <div className="p-8 text-center relative">
        ...
        <p className="text-slate-300 relative">Start your journey</p>
      </div>
